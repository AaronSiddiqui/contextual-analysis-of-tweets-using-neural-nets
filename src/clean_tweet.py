...
def clean_tweet(tweet, rem_urls=True, rem_mentions=True, rem_texemojis=True,
                repl_mentions=False, rem_htags=True, dec_html=True,
                conv_lcase=True, expand_abbrev=True, rem_punc=True,
                repl_nonprint_chars=True, rem_wspace=True):
    ...
    if rem_texemojis:
        tweet = re.sub(r" [:;Xx=][038DdPpSsL<>/\\\(\)\[\]\{\}\-]{1,2}", " ", tweet)
